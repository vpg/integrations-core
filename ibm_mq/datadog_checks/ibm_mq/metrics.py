...
class Metrics:
    ...
    def queue_metrics(self):
        return {
            ...
            'oldest_message_age': self.pymqi.CMQCFC.MQIACF_OLDEST_MSG_AGE,
            'input_handles': self.pymqi.CMQCFC.MQIA_OPEN_INPUT_COUNT,
            'output_handles': self.pymqi.CMQCFC.MQIA_OPEN_OUTPUT_COUNT,
        }
